...
urlpatterns = [
    ...
    path('spedizione/conferma-pagamento/', views.conferma_pagamento, name='conferma_pagamento'),
    path('spedizione/pagamento-confermato/', views.pagamento_confermato, name='pagamento_confermato'),
    path('spedizione/pagamento-fallito/', views.pagamento_fallito, name='pagamento_fallito'),
