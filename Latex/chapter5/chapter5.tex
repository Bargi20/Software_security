...
./venv/Scripts/Activate.ps1       # UTENTE WINDOWS
...
Infine, è necessario avviare i container Docker (previa apertura ) per inizializzare la rete blockchain privata. Per fare ciò, basta scrivere questo comando nella root del progetto: 
\begin{terminal}
docker-compose up -d
\end{terminal}
...
Dopo aver inizializzato tutto il necessario per l'applicazione web, bisogna configurare correttamente MetaMask per interagire con la rete blockchain. Aggiungendo la rete personalizzata con i seguenti parametri: 
\begin{itemize}
