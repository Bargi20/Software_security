...
\begin{figure}[ht!]
	\centering
	\includegraphics[width=0.9\columnwidth]{chapter4/immagini/Monitor_RE_safety.png}
    \caption{Modello del monitor di Runtime Enforcement della proprietà di safety.}
\end{figure}

\begin{figure}[ht!]
	\centering
	\includegraphics[width=0.9\columnwidth]{chapter4/immagini/Monitor_RE_response.png}
    \caption{Modello del monitor di Runtime Enforcement della proprietà di response.}
\end{figure}
