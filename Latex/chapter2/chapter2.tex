...
\begin{itemize}
	\item \textbf{Sistema}: questo attore rappresenta il sistema che gestisce gli ordini, i pagamenti, le spedizioni e l'accesso a sé stesso. Esso interagisce con tutti gli altri attori per garantire il corretto funzionamento del processo di effettuazione degli ordini.
\end{itemize}
