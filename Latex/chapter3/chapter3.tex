...
\\\\
\keyword{label} \texttt{"LoginEffettuato"} = \variable{statoLogin} = \numberb{8};
\\
\keyword{label} \texttt{"Timeout"} = \variable{statoLogin} = \numberb{12};
\\\\
\keyword{module} \variable{login\_function}
\\\\
\variable{statoLogin} : \bracketcontent{0..21} \keyword{init} \numberb{0};
\\
\variable{c\_log} : \bracketcontent{0..numTentativi} \keyword{init} \variable{numTentativi};
\\
\variable{c\_mfa} : \bracketcontent{0..numTentativi} \keyword{init} \variable{numTentativi};
\\
\variable{c\_rpass} : \bracketcontent{0..numTentativi} \keyword{init} \variable{numTentativi};
\\
\variable{c\_email} : \bracketcontent{0..numTentativi} \keyword{init} \variable{numTentativi};
\\
\variable{c\_rinvioMFA} : \bracketcontent{0..numTentativi} \keyword{init} \variable{numTentativi};
\\
\variable{c\_rinvioRPASS} : \bracketcontent{0..numTentativi} \keyword{init} \variable{numTentativi};
\\
\variable{c\_nuovaPass} : \bracketcontent{0..numTentativi} \keyword{init} \variable{numTentativi};
\\\\
