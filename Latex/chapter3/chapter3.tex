...
\\
\bracketcontent{PasswordDimenticata} (\variable{p1}=\numberb{13}) -\gt (\variable{p1'}=\numberb{5});
\\
\\
...
\\ 
% stato 4
\cmt{// uscenti da stato 4 -> stato di login effettuato} \\
\\
% stato 5
\cmt{// uscenti da stato 5} \\
...
\\
% stato 11
\cmt{// uscenti da stato 11 -> stato di errore} \\ \\
\keyword{endmodule}
\end{highlightPrism}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
