...
\begin{itemize}
    \item \textbf{$C_L$}: contatore dei tentativi di login (inserimento username e password);
    \item \textbf{$C_R$}: contatore dell'invio delle email di reset della password;
    \item \textbf{$C_M$}: contatore dei tentativi d'inserimento del codice MFA;
    \item \textbf{$C_E$}: contatore dell'invio delle email del codice MFA.
\end{itemize}